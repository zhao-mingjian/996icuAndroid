...
public class Api {
    ...
    */
    ...
    public static OkHttpClient getOkHttpClient() {
        Api retrofitManager = sRetrofitManager.get(HostType.BASE_URL);
        if (retrofitManager == null) {
            retrofitManager = new Api(HostType.BASE_URL);
            sRetrofitManager.put(HostType.BASE_URL, retrofitManager);
        }
